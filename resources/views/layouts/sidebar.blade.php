<aside id="sidebar"
    class="fixed inset-y-0 left-0 w-64 bg-blue-600 text-white flex flex-col transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out z-50">
        ...
        <ul class="space-y-2 p-4">
            <li>
                <a href="{{ route('dashboard') }}"
                    class="flex items-center p-2 hover:bg-blue-700 rounded text-sm sm:text-base">
